...
class WarehouseStockInForm extends Component
{
    public $warehouseId;
    public $productId;
    public $quantity;
    ...
    public function render()
    {
        ...
        return view('livewire.warehouse.warehouse-stock-in-form');
    }
    ...
    public function stockIn()
    {
        ...
        try {
            ...
            $result = $inventoryService->stockIn([
                ...
                'detail' => $this->detail ?? 'Stock In via Form',
            ...
            $this->dispatch('stockOperationCompleted', ['type' => 'stock-in', 'warehouseId' => $this->warehouseId]);

        } catch (\Exception $e) {
            session()->flash('error', $e->getMessage());
            Log::error('Stock In Form Error: ' . $e->getMessage());
        }
    }
