...
class ProductService
{
    ...
    private function validateProductData(array $data, string $operation = 'create', Product $product = null)
    {
        $rules = [
            ...
            'buy_vat_id' => 'required|exists:vats,id',
            'buy_withholding_id' => 'required|exists:withholdings,id',
            'buy_description' => 'nullable|string',
            'sale_price' => 'required|numeric|min:0',
            'sale_vat_id' => 'required|exists:vats,id',
            'sale_withholding_id' => 'required|exists:withholdings,id',
