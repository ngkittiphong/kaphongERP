    ...
    public function run()
    {
        ...
        for ($i = 1; $i <= 5; $i++) {
            ...
            $createdBranches[] = [
                ...
                'branch_no' => $branch->branch_no, // Auto-generated by model hook
        ...
        // Display generated branch codes and numbers
        $this->command->info('Generated Branch Codes and Numbers:');
        foreach ($createdBranches as $branch) {
            $this->command->line("  - Code: {$branch['branch_code']} | Number: {$branch['branch_no']} | {$branch['name_en']} [Head Office: {$branch['is_head_office']}]");
        }
    }
}