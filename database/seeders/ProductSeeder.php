...
class ProductSeeder extends Seeder
{
    public function run()
    {
        ...
        $this->command->info('Creating products with auto-generated product_no...');

        foreach (range(1, 10) as $i) {
            $product = Product::create([
                // product_no will be auto-generated by the model
            ...
            $this->command->info("Created product: {$product->name} with product_no: {$product->product_no}");
        }
