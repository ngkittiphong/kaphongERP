        ...
        <ul class="switch-theme-colors clearfix">
            ...
            <li>
                <div class="theme" id="light">
                    <img src="{{ asset('assets/images/themes/light.jpg') }}" alt=""/>
                </div>				
            </li>
            <li class="list-title clearfix">Mirage</li>
            <li>
                <div class="theme pull-left" id="mirage">
                    <img src="{{ asset('assets/images/themes/mirage_dark.jpg') }}" alt=""/>
                </div>				
            </li>			
            <li>
                <div class="theme pull-left" id="mirage_light">
                    <img src="{{ asset('assets/images/themes/mirage_light.jpg') }}" alt=""/>
                </div>				
            </li>
            <li>
                <div class="theme pull-left" id="mirage_light_sidebar">
                    <img src="{{ asset('assets/images/themes/mirage_light_sidebar.jpg') }}" alt=""/>
                </div>				
            </li>										
            <li class="list-title clearfix">Burnt Sienna</li>
            <li>
                <div class="theme pull-left" id="burnt_sienna_dark">
                    <img src="{{ asset('assets/images/themes/burnt_sienna_dark.jpg') }}" alt=""/>
                </div>				
            </li>			
            <li>
                <div class="theme pull-left" id="burnt_sienna_light">
                    <img src="{{ asset('assets/images/themes/burnt_sienna_light.jpg') }}" alt=""/>
                </div>				
            </li>
            <li>
                <div class="theme pull-left" id="burnt_sienna_light_sidebar">
                    <img src="{{ asset('assets/images/themes/burnt_sienna_light_sidebar.jpg') }}" alt=""/>
                </div>				
            </li>		
            ...
            <li>
                <div class="theme pull-left" id="amethyst_dark">
                    <img src="{{ asset('assets/images/themes/amethyst_dark.jpg') }}" alt=""/>
                </div>				
            </li>			
            <li>
                <div class="theme pull-left" id="amethyst_light">
                    <img src="{{ asset('assets/images/themes/amethyst_light.jpg') }}" alt=""/>
                </div>				
            </li>
            <li>
                <div class="theme pull-left" id="amethyst_light_sidebar">
                    <img src="{{ asset('assets/images/themes/amethyst_light_sidebar.jpg') }}" alt=""/>
                </div>				
            </li>		
            ...
            <li>
                <div class="theme pull-left" id="fuchsiablue_dark">
                    <img src="{{ asset('assets/images/themes/fuchsiablue_dark.jpg') }}" alt=""/>
                </div>				
            </li>			
            <li>
                <div class="theme pull-left" id="fuchsiablue_light">
                    <img src="{{ asset('assets/images/themes/fuchsiablue_light.jpg') }}" alt=""/>
                </div>				
            </li>
            <li>
                <div class="theme pull-left" id="fuchsiablue_light_sidebar">
                    <img src="{{ asset('assets/images/themes/fuchsiablue_light_sidebar.jpg') }}" alt=""/>
                </div>				
            </li>
            ...
            <li>
                <div class="theme pull-left" id="pictonblue_dark">
                    <img src="{{ asset('assets/images/themes/pictonblue_dark.jpg') }}" alt=""/>
                </div>				
            </li>			
            <li>
                <div class="theme pull-left" id="pictonblue_light">
                    <img src="{{ asset('assets/images/themes/pictonblue_light.jpg') }}" alt=""/>
                </div>				
            </li>
            <li>
                <div class="theme pull-left" id="pictonblue_light_sidebar">
                    <img src="{{ asset('assets/images/themes/pictonblue_light_sidebar.jpg') }}" alt=""/>
                </div>				
            </li>
            ...
            <li>
                <div class="theme pull-left" id="junglegreen_dark">
                    <img src="{{ asset('assets/images/themes/junglegreen_dark.jpg') }}" alt=""/>
                </div>				
            </li>			
            <li>
                <div class="theme pull-left" id="junglegreen_light">
                    <img src="{{ asset('assets/images/themes/junglegreen_light.jpg') }}" alt=""/>
                </div>				
            </li>
            <li>
                <div class="theme pull-left" id="junglegreen_light_sidebar">
                    <img src="{{ asset('assets/images/themes/junglegreen_light_sidebar.jpg') }}" alt=""/>
                </div>				
            </li>
            ...
            <li>
                <div class="theme pull-left" id="fern_dark">
                    <img src="{{ asset('assets/images/themes/fern_dark.jpg') }}" alt=""/>
                </div>				
            </li>			
            <li>
                <div class="theme pull-left" id="fern_light">
                    <img src="{{ asset('assets/images/themes/fern_light.jpg') }}" alt=""/>
                </div>				
            </li>
            <li>
                <div class="theme pull-left" id="fern_light_sidebar">
                    <img src="{{ asset('assets/images/themes/fern_light_sidebar.jpg') }}" alt=""/>
                </div>				
            </li>
            ...
            <li>
                <div class="theme pull-left" id="sunglow_dark">
                    <img src="{{ asset('assets/images/themes/sunglow_dark.jpg') }}" alt=""/>
                </div>				
            </li>			
            <li>
                <div class="theme pull-left" id="sunglow_light">
                    <img src="{{ asset('assets/images/themes/sunglow_light.jpg') }}" alt=""/>
                </div>				
            </li>
            <li>
                <div class="theme pull-left" id="sunglow_light_sidebar">
                    <img src="{{ asset('assets/images/themes/sunglow_light_sidebar.jpg') }}" alt=""/>
                </div>				
            </li>
            ...
            <li>
                <div class="theme pull-left" id="regentgrey_dark">
                    <img src="{{ asset('assets/images/themes/regentgrey_dark.jpg') }}" alt=""/>
                </div>				
            </li>			
            <li>
                <div class="theme pull-left" id="regentgrey_light">
                    <img src="{{ asset('assets/images/themes/regentgrey_light.jpg') }}" alt=""/>
                </div>				
            </li>
            <li>
                <div class="theme pull-left" id="regentgrey_light_sidebar">
                    <img src="{{ asset('assets/images/themes/regentgrey_light_sidebar.jpg') }}" alt=""/>
                </div>				
            </li>
        </ul>	
    </div>
